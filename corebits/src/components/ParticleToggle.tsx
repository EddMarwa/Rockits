...
export default function ParticleToggle() {
  ...
  function toggle() {
    ...
    window.dispatchEvent(new CustomEvent('particles:toggle', { detail: { disabled: next } }));
  }
  ...
  return (
    <button
      ...
      onClick={toggle}
      className="fixed right-4 top-4 z-50 inline-flex items-center gap-2 px-3 py-2 rounded bg-black/40 border border-white/6 text-sm text-slate-100 backdrop-blur-sm hover:bg-black/50"
    >
