    ...
    <section id="certs" className="mt-16">
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          ...
          <p className="opacity-80">CoreBits operates under applicable law and shares its official documents, certificates, and mining performance data publicly.</p>
        ...
        <div>
          ...
          <p className="opacity-80">CoreBits operates transparently and is registered in good standing with relevant authorities.</p>
        </div>
      </div>
